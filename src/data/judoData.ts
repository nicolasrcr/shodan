...
export const sections = [
  ...
  { id: 'placar', label: 'Placar', labelJp: '得点', icon: '🏆' },
...
export const homeCards = [
  ...
  { title: 'Sistema de Placar', desc: 'Pontuação e penalidades', icon: '🏆', section: 'placar' },
...
export const searchIndex = [
  ...
  { section: 'placar', title: 'Pontuação', keywords: 'ippon wazari yuko ponto score placar' },
  { section: 'placar', title: 'Penalidades', keywords: 'shido hansoku penalidade falta' },
  { section: 'placar', title: 'Golden Score', keywords: 'prorrogação empate morte súbita' },
  { section: 'placar', title: 'Comandos Árbitro', keywords: 'hajime matte sore-made osaekomi' },
  { section: 'regras', title: 'Regras Arbitragem', keywords: 'regras arbitragem competição' },
